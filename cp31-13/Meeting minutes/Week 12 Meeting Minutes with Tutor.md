_ **Subject: Week 12 Client meeting** _
...
_ **Date: Tuesday, 17th November** _

_ **Time: 2:30-2:40** _

_**Attendees: Keenan, Johnny, Oscar, Tamara, Chengdong, Osama, Tutor (Waheeb)**_
...
| . | _._ | _Updated Stopsign code implemented in simulator_ | _._ | _Oscar_ | _._ |
| _ **2** _ | _What is in progress?_ | _New arrow turning code need testing in simulator, then pr_ | _Test code in simulator._ | _Osama, Chengdong, Tamara, Oscar._ | _._ |
